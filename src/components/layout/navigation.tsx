    ...
    <nav className='w-full h-20 flex items-center bg-black md:h-24 lg:h-32'>
      <div className='w-full flex items-center justify-between lg:container lg:mx-auto'>
        ...
        <span className='w-full flex items-center justify-between gap-14 lg:w-fit'>
          ...
          <ul
            className={clsx(
              'absolute w-full h-screen top-20 md:top-24 bg-raven translate-x-[-100%] transition-transform duration-300 ease-in-out lg:relative lg:w-auto lg:h-min lg:top-0 lg:bg-transparent lg:inline-flex lg:gap-7 lg:translate-x-[0%]',
